  ...
  return (
    <div className="p-6 lg:p-8 max-w-3xl">
        ...
        <div className="flex items-start gap-5">
          ...
          <div className="flex-1 space-y-4">
            <div className="grid sm:grid-cols-2 gap-4">
              <div>
                <label className="label" htmlFor="nom-de-lentreprise">Nom de l'entreprise</label>
              <input
                  id="nom-de-lentreprise" type="text"
                  defaultValue="ThermoConfort Paris"
                  className="input-field"
                />
              </div>
              <div>
                <label className="label" htmlFor="nom-du-dirigeant">Nom du dirigeant</label>
              <input id="nom-du-dirigeant" type="text" defaultValue="Jean-Marc Durand" className="input-field" />
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="space-y-4">
          <div className="grid sm:grid-cols-2 gap-4">
            <div>
              ...
              <input id="tlphone" type="tel" defaultValue="01 23 45 67 89" className="input-field" />
            </div>
            <div>
              <label className="label" htmlFor="email-professionnel">Email professionnel</label>
              <input
                id="email-professionnel" type="email"
          ...
          <div>
            <label className="label" htmlFor="site-web">Site web</label>
              <input
              id="site-web" type="url"
      ...
      <div className="bg-white rounded-xl border border-slate-200 p-6 mb-5">
        ...
        <div>
          <label className="label" htmlFor="prsentation-de-votre-entrepris">Présentation de votre entreprise</label>
              <textarea
            id="prsentation-de-votre-entrepris" rows={5}
      ...
      <div className="bg-white rounded-xl border border-slate-200 p-6">
        ...
        <div className="space-y-3">
          <div>
            <label className="label" htmlFor="dpartements-couverts">Départements couverts</label>
              <input
              id="dpartements-couverts" type="text"
          ...
          <div>
            <label className="label" htmlFor="rayon-maximum-km">Rayon maximum (km)</label>
              <select id="rayon-maximum-km" className="input-field">
