...
const PLANS = [
  {
    ...
    features: [
      ...
      { label: 'Jusqu\'à 2 leads/mois', included: true },
  ...
  },
  {
    ...
    features: [
      { label: 'Profil professionnel', included: true },
      { label: 'Jusqu\'à 10 leads/mois', included: true },
      ...
      { label: 'Leads supplémentaires disponibles', included: false },
      { label: 'Support téléphonique', included: false },
    ],
    cta: 'Démarrer Pro',
  ...
  },
  {
    ...
    features: [
      { label: 'Profil professionnel', included: true },
      { label: 'Jusqu\'à 25 leads/mois', included: true },
