              ...
              <form className="space-y-4">
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <input type="text" placeholder="Jean" className="input-field" />
                  </div>
                  <div>
                    <label className="label">Nom</label>
                    <input type="text" placeholder="Dupont" className="input-field" />
                  </div>
                </div>
                <div>
                  <label className="label">Email</label>
                  <input type="email" placeholder="jean.dupont@email.fr" className="input-field" />
                </div>
                {userType === 'pro' && (
                  <>
                    <div>
                      <label className="label">Nom de l'entreprise</label>
                      <input type="text" placeholder="Mon Entreprise SARL" className="input-field" />
                    </div>
                    <div>
                      <label className="label">SIRET</label>
                      <input type="text" placeholder="123 456 789 00012" className="input-field" />
                    </div>
                  </>
                )}
                <div>
                  <label className="label">Mot de passe</label>
                  <input type="password" placeholder="8 caractères minimum" className="input-field" />
                </div>
