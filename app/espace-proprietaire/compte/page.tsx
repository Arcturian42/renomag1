        ...
        <div className="bg-white rounded-xl border border-slate-200 p-6">
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            <div>
              ...
              <input type="text" className="input-field" defaultValue="Jean" />
            </div>
            <div>
              <label className="label">Nom</label>
              <input type="text" className="input-field" defaultValue="Dupont" />
            </div>
            <div>
              <label className="label">Email</label>
              <input type="email" className="input-field" defaultValue="jean.dupont@email.fr" />
            </div>
            <div>
              <label className="label">Téléphone</label>
              <input type="tel" className="input-field" defaultValue="06 12 34 56 78" />
            </div>
          </div>
        ...
        <div className="bg-white rounded-xl border border-slate-200 p-6">
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <input type="text" className="input-field" defaultValue="75016" />
            </div>
          </div>
          <div className="mt-5 flex justify-end">
            <button className="btn-primary px-5 py-2.5">Enregistrer</button>
